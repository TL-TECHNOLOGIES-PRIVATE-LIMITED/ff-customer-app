          ...
          return Column(
            ...
            children: [
              ...
              ProductListRatingBuilderWidget(
                averageRating: widget.product.averageRating.toString().toDouble,
                ...
                children: [
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              CustomTextLabel(
                                text:
                                    "${widget.variants[availableIndex].measurement} ${widget.variants[availableIndex].stockUnitName}",
                                style: TextStyle(
                                  fontSize: 12,
                  ...
                  Expanded(
                    child: ProductCartButton(
                      ...
                      count: int.parse(
                                widget.variants[availableIndex].status
                                    .toString(),
                              ) ==
                              0
                          ? -1
                          : int.parse(
                              widget.variants[availableIndex].cartCount
                                  .toString(),
                            ),
